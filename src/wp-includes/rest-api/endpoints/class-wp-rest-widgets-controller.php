...
class WP_REST_Widgets_Controller extends WP_REST_Controller {
	...
	protected function find_widgets_sidebar( $widget_id ) {
		...
		return new WP_Error( 'rest_widget_not_found', __( 'No widget was found with that id.' ), array( 'status' => 404 ) );
	}
	...
	public function get_item_schema() {
		...
		$this->schema = array(
			...
			'properties' => array(
				...
				'widget_class'  => array(
					'description' => __( 'Class name of the widget implementation.' ),
					'type'        => 'string',
					'context'     => array( 'view', 'edit', 'embed' ),
				),
				'name'          => array(
					'description' => __( 'Name of the widget.' ),
					'type'        => 'string',
					'context'     => array( 'view', 'edit', 'embed' ),
				),
				'description'   => array(
				...
				'number'        => array(
					'description' => __( 'Number of the widget.' ),
					'type'        => 'integer',
					'context'     => array( 'view', 'edit', 'embed' ),
				),
				'rendered'      => array(
				...
				'settings'      => array(
					'description' => __( 'Settings of the widget.' ),
					'type'        => 'object',
					'context'     => array( 'view', 'edit', 'embed' ),
					'default'     => array(),
				),
